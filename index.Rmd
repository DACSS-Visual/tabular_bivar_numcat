...
3. [Complez and custom plots](#part3)
...
```
As there seems to be lots s asymmetry, let's explore with boxplots several lengths using **ggarrange** from _ggpubr_:
...
pairwise.wilcox.test(crimePrecinct$yearsToReport,crimePrecinct$Precinct,
                     p.adjust.method = "BH")
```
Arguably, EAST differs from NORTH and SOUTH; and WEST from NORTH. What plot may help us show that?
...
We need annotarions for each violin. Too much work, unless we create a function:
